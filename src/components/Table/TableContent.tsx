    ...
    <div className={styles.wrapper}>
      ...
      >
        <TableHead>
          <TableRow>
            {head.map((item) => (
              <TableCell className={(styles.table_cell, styles.table_header_action)}>
        ...
        <TableBody>
          {body.map((item) => (
            ...
            >
              ...
              <TableCell className={styles.table_cell}>{item.status}</TableCell>
              <TableCell className={(styles.table_cell, styles.table_cell_action)}>
